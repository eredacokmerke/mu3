...
//        catch (IOException e)
//        {
//            HataYoneticisi.ekranaHataYazdir("19", getMa().getApplicationContext().getString(R.string.xml_olusturulamadi) + e.getMessage() + ", " + MainActivity.getCnt().getString(R.string.dosya) + " : " + xmlDosyaYolu);
//        }
//    }
//
//    @Override
