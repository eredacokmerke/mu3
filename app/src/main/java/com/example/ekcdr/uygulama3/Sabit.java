...
public class Sabit
{
    ...
    public static final String KAYIT_ONTANIMLI_RENK = "#FF8000";
    public static final String DURUM_YENI = "0";
    public static final String DURUM_TAMAMLANDI = "1";
    public static final String FRAGMENT_TAG = "fragment_tag";
    public static final String FRAGMENT_YAZI = "fragment_yazi";
    ...
    public static final int OLAY_ICINE_GIR = 0;
    public static final int OLAY_SECIM_YAP = 1;
